...
function wp_bootstrap_starter_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'nwp_search_bar', 
        array(
            'title' => __('Search Bar', 'wp-bootstrap-starter'),
            'priority' => 10,
        )
    );

    $wp_customize->add_setting(
        'search_bar_vis', array (
            'default' => '1',
            'capability' => 'edit_theme_options',
    ...
    $wp_customize-> add_control(
        new WP_Customize_Control(
            ...
            array(
            'type'     => 'checkbox',
            'settings' => 'search_bar_vis',
            'label'    => 'Search Bar Visibility',
            'section'    => 'nwp_search_bar',
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control($wp_customize, 
            'search_bar_bg_control',
            array(
                'label' => 'Background Color',
                'section' => 'nwp_search_bar',
                'settings' => 'search_bar_bg_color'
            )
        )
    );
    ...
    $wp_customize->add_section(
        'header_image',
        array(
            'title' => __( 'Top Header Banner', 'wp-bootstrap-starter' ),
            'priority' => 30,
        )
    );
...

{
    ...
    <style type="text/css">
        ...
        .search-header { 
            background-color: <?php echo esc_attr(get_theme_mod('search_bar_bg_color'));?> ;    
            <?php if(!get_theme_mod('search_bar_vis')){ 
                ?> display: none; <?php
            } ?>
        ...
        #banner-head{
            <?php if(has_header_image()) { ?> background-image: url('<?php header_image(); ?>'); <?php } ?>
            background-color: <?php echo esc_attr(get_theme_mod('header_bg_color_setting')); ?> 
        }
    </style>
    <?php
}
